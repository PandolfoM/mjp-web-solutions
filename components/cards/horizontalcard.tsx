...
function HorizontalCard({ svg, title, subtitle }: Props) {
  return (
    <div className="min-h-56 max-h-56 overflow-hidden flex flex-col items-center justify-center gap-[15px] bg-gradient-radial to-80% from-card/[10%] to-card/[2%] rounded-[10px] py-[25px] px-10">
      <Image src={svg} alt=""/>
